...
// creates an Podcast representation of this feed
func (f *Feed) ToPodcast() (string, error) {
	r := &Podcast{f}
	return ToXML(r)
}

// Writes an Podcast representation of this feed to the writer.
func (f *Feed) WritePodcast(w io.Writer) error {
	return WriteXML(&Podcast{f}, w)
}
